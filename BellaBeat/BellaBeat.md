...
2. # <a name="_toc137838585"></a>Ask
   1. ## <a name="_toc137838586"></a>Business task
   ...
   2. ## <a name="_toc137838587"></a>Stakeholders
...
3. # <a name="_toc137838588"></a>Prepare
   1. ## <a name="_toc137838589"></a>Data Used
      The data source is **FitBit Fitness Tracker data** stored in Kaggle.

   2. ## <a name="_toc137838590"></a>Accessibility and Privacy of data
   ...
   3. ## <a name="_toc137838591"></a>Data Summary
   ...
   4. ## <a name="_toc137838592"></a>Data Organization
   ...
   5. ## <a name="_toc137838593"></a>Data Limitations and Integrity
...
1. # <a name="_toc137838594"></a>Process
   1. ## <a name="_toc137838595"></a>Datasets Selected
   ...
   1. ## <a name="_toc137838596"></a>Use Excel to Clean data
   ...
   1. ## <a name="_toc137838597"></a>Upload Datasets to SQL
...
5. # <a name="_toc137838598"></a>Analyze and Share
   1. ## <a name="_toc137838599"></a>Margining datasets
      <a name="_toc132936035"></a>Join all the selected datasets that are daily and share same column to use if for the analysis
         ``` sql
         SELECT
         A.Id,
         A.Calories,
   ...
   1. ## <a name="_toc137838600"></a>User verification
      ...
      ```
   1. ## <a name="_toc137838601"></a>Logged users 
...
1. ## <a name="_toc137838602"></a>Users types 
   ...
   1. ## <a name="_toc137838603"></a>Logged user’s summary 
   ...
   1. <a name="_toc137838604"></a>compare calories, total steps per weekday
      ```sql
   ...
   1. ## <a name="_toc137838605"></a>compare total steps, total sleep per weekday
      ```sql
...
#
1. # <a name="_toc137838606"></a>Act
   1. ## <a name="_toc137838607"></a>Conclusion & Recommendations
   ...
   1. ## Provide notification for steps:
   ...
   1. ## Provide graph analysis about Calories:
